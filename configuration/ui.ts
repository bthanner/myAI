...
export const CHAT_HEADER: string = `Madewell Personal Shopping Assistant`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `COPYRIGHT UNC BLT`;
export const CLEAR_BUTTON_TEXT: string = `CLEAR TEXT`;
export const PAGE_TITLE: string = `Madewell Personal Shopping Assistant`;
